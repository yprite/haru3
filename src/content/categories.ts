...
export const CATEGORIES: readonly Category[] = [
  ...
  // Level 3 - 네이티브
  {
    id: 'l3_emotion',
    name: '감정/기분',
    description: '감정 표현, 공감하기',
    levelId: 'level_3',
    icon: '💭',
    order: 1,
    sentenceCount: 10,
    keyPatterns: ['~と思います', '~てよかった', '~そうですね'],
  },
  {
    id: 'l3_opinion',
    name: '의견/생각',
    description: '의견 말하기, 동의/반대',
    levelId: 'level_3',
    icon: '💬',
    order: 2,
    sentenceCount: 10,
    keyPatterns: ['~と思います', '~かもしれません', '~ではないでしょうか'],
  },
  {
    id: 'l3_business',
    name: '비즈니스',
    description: '회의, 약속, 업무 표현',
    levelId: 'level_3',
    icon: '💼',
    order: 3,
    sentenceCount: 10,
    keyPatterns: ['~させていただきます', '~いただけますか', '~について'],
  },
  {
    id: 'l3_culture',
    name: '문화/예절',
    description: '일본 문화, 예절 표현',
    levelId: 'level_3',
    icon: '🎎',
    order: 4,
    sentenceCount: 10,
    keyPatterns: ['~なんですね', '~とのことです', '~ものです'],
  },
  {
    id: 'l3_advanced',
    name: '고급 표현',
    description: '뉘앙스 있는 자연스러운 표현',
    levelId: 'level_3',
    icon: '🎯',
    order: 5,
    sentenceCount: 10,
    keyPatterns: ['~っぽい', '~わけではない', '~ことにする'],
  },
] as const;
